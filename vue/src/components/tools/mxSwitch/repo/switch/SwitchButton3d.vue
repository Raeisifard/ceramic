<template>
    <div style="transform: scale(.19,.27);">
        <label id="switch" class="button">
            <input type="checkbox" @click="sendSetting($event)" v-model="checked">
...
<style scoped>
    @import url(/src/css/switchButton3d/css.css);
