<template>
    <div class="center">
        <input class="tgl tgl-skewed" :id="id" type="checkbox" @click="sendSetting($event)"
               v-model="checked"/>
...
<script>
  export default {
    name: "SkewedGreenToggle",
    data() {
      return {
        checked: true,
        id: "lgt" + ( this.cell ? "flat_"+this.cell.getId() : "flat_2" )
      }
    },
    ...
    mounted() {
      if (typeof this.value === 'undefined') {
        this.checked = this.cell.getData().setting._.state;
      } else {
